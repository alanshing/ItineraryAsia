        ...
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/backend') }}">
                    <img src={{ asset("images/itinerarylogo-02.png") }} alt="itinerarylogo" class="logo"/>
                </a>
                            ...
                            @if(Auth::user()->isAdmin())
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route('advertisements.index') }}">
                                            {{ __('Advertisement List') }}
                                        </a>
                                        <a class="dropdown-item" href="{{ route('advertisements.create') }}">
                                            {{ __('Create New') }}
                                        </a>
                                    </div>
                                </li>
